...
if __name__ == '__main__':
    # Epoch 100/100 - Train Loss: 1.0610, Train Acc: 0.6829,
    # Val Loss: 2.436008922958374, Val Acc: 0.4527,
    # Test Loss: 2.2938, Test Acc: 0.4624
    ...
    cpe_vit = CPEViT(image_size=args["image_size"], patch_size=args["patch_size"], num_layers=args["num_layers"],
