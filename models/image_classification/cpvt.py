...
if __name__ == '__main__':
    # Epoch 100/100 - Train Loss: 0.8073, Train Acc: 0.7525,
    # Val Loss: 2.5111395767211913, Val Acc: 0.4724,
    # Test Loss: 2.3686, Test Acc: 0.4842
    ...
    cpvt = CPVT(image_size=args["image_size"], patch_size=args["patch_size"], num_layers=args["num_layers"],
    ...
    cpvt.to("cuda")
    metrics = cpvt.train_model(cpvt, train_loader, test_loader, 100, val_loader)
